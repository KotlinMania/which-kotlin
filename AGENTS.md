...
This file is the quick-reference operating contract for which-kotlin. The longer
...
which-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`which`](https://crates.io/crates/which). Upstream Rust is the behavioral oracle while the
