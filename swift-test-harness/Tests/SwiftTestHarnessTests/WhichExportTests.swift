...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Which.swiftmodule/`
...
//      `import Which` above would fail at compile time.
//
//   2. The static archive `libWhich.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Which" }` and
//      `flattenPackage = "io.github.kotlinmania.which"` configuration in
